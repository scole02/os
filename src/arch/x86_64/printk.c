...
static void print_char(char c) { VGA_display_char(c); }
static void print_str(const char *str) { VGA_display_str(str); }
static void print_uchar(unsigned char c)
{
    char * num_str = "\0";
...
static void print_short(short h, int base)
{   
    char * num_str = "\0";
    htoa(h, num_str, base);
    VGA_display_str(num_str); 
